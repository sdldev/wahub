...
export const createSessionController = () => {
    ...
    app.post('/start', requestValidator('json', startSessionSchema), async (c) => {
        ...
        const validation = await SessionManagementService.validateSessionCreation(payload.session, payload.phoneNumber);
    ...
    app.post('/check-phone', requestValidator('json', checkPhoneSchema), async (c) => {
        ...
        const existingSession = await SessionManagementService.checkExistingSession(payload.phoneNumber);
        if (existingSession) {
            return c.json({
